...
import static com.patrikdufresne.fontawesome.FontAwesome.crosshairs;
...
public class XCalendarSelectTodayWidget extends AbstractXCalendarWidget {
	...
	protected boolean onMouseUp(final XCalendarMouseUpEvent event) {
		...
		XCalendarModel model = popup.getModel(); Date now = model.now();
		super.submit(new XCalendarSelectAction(now, true)); return true;
	}
