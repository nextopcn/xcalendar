...
import static com.patrikdufresne.fontawesome.FontAwesome.chevron_down;

/**
 * 
 * @author chenby
 */
public class XCalendarDecrWidget extends AbstractXCalendarWidget {
	//
	 ...
	 * 
	 */
	public XCalendarDecrWidget(XCalendar popup, XCalendarTime type) {
	...
	protected boolean onMouseUp(final XCalendarMouseUpEvent event) {
		...
		type.decr(v); return submit(new XCalendarSelectAction(v.getDate()));
	}
